...
define('ace/mode/nvp2_worker', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/worker/mirror', 'ace/mode/nvp2/nvp2parse'], function(require, exports, module) {
	...
	(function() {
	    ...
	    this.onUpdate = function() {
		    ...
		    lexer = new Nvp2Lexer(cstream);
		    tstream = new org.antlr.runtime.CommonTokenStream(lexer);
		    parser = new Nvp2Parser(tstream);
		    try {
		    	parser.rule_Nvp2();
		    } catch(err) {
...
define('ace/mode/nvp2/nvp2parse', ['require', 'exports', 'module' ], function(require, exports, module) {

(function (root, name, factory) {
   factory(exports)
}(this, 'nvp2parse', function (exports) {
