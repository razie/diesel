...
define('ace/mode/nvp1_worker', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/worker/mirror', 'ace/mode/nvp1/nvp1parse'], function(require, exports, module) {
...
(function() {
    ...
    this.onUpdate = function() {
	    ...
	    lexer = new Nvp1Lexer(cstream);
	    tstream = new org.antlr.runtime.CommonTokenStream(lexer);
	    parser = new Nvp1Parser(tstream);
	    try {
	    	parser.rule_DomainModel();
	    } catch(err) {
...
define('ace/mode/nvp1/nvp1parse', ['require', 'exports', 'module' ], function(require, exports, module) {

(function (root, name, factory) {
   factory(exports)
}(this, 'nvp1parse', function (exports) {
