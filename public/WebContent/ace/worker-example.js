...
define('ace/mode/example_worker', ['require', 'exports', 'module' , 'ace/lib/oop', 'ace/worker/mirror', 'ace/mode/example/exampleparse'], function(require, exports, module) {

var oop = require("../lib/oop");
var Mirror = require("../worker/mirror").Mirror;
var exampleparse = require("../mode/example/exampleparse");

importScripts("../parser/antlr-all-min.js");
importScripts("../parser/ExampleLexer.js");
importScripts("../parser/ExampleParser.js");
...
(function() {
    ...
    this.onUpdate = function() {
	    ...
	    lexer = new ExampleLexer(cstream);
	    tstream = new org.antlr.runtime.CommonTokenStream(lexer);
	    parser = new ExampleParser(tstream);
	    try {
	    	parser.rule_Example();
	    } catch(err) {
...
define('ace/mode/example/exampleparse', ['require', 'exports', 'module' ], function(require, exports, module) {

(function (root, name, factory) {
   factory(exports)
}(this, 'exampleparse', function (exports) {
