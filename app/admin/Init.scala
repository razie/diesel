...
object Init extends Logging {
  ...
  def initDb() = {
    ...
    for (
      t <- Seq("UserGroup", "User", "Profile", "UserEvent", "Task", "UserTask", "Category", "Stuff",
        /*"WikiEntry", "WikiEntryOld", "WikiLink", "Audit",*/ "UserWiki", "Audit")
    ...
    val users = List(User ("andrei", "Andrei", "Cojocaru", 2000, e("a@racerkidz.com"), e("asdf")),
      ...
      User ("razie", "Razie", "Cojocaru", 1970, e("r@racerkidz.com"), e("asdf"), "admin"),
      User ("ileana", "Ileana", "Cojocaru", 1969, e("i@racerkidz.com"), e("asdf"), "admin"))
    ...
    def w(cat: String, name: String, wiki: String = "") = WikiEntry (cat, model.Wikis formatName name, name, "markdown", wiki)
