...
class Test1 extends FlatSpec with MustMatchers with UrlTester {
...
class Test1Edit extends FlatSpec with MustMatchers with UrlTester {
  implicit val hostport = "http://localhost:9000"
...
class Test1Forms extends FlatSpec with MustMatchers with UrlTester {
  implicit val hostport = "http://localhost:9000"
