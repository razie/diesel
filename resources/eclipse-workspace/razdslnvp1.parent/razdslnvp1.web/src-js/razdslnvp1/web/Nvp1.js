 ...
 */
(function() {
	rap.registerTypeHandler("razdslnvp1.web.editor.widget.Nvp1", {
		factory : function(properties) {
			return new razdslnvp1.web.editor.widget.Nvp1(properties);
		},
		destructor : "destroy",
	...
	rwt.qx.Class.define("razdslnvp1.web.editor.widget.Nvp1", {
		...
		members : {
			createEditor : function() {
				...
				var workerPath = 'rwt-resources/src-js/razdslnvp1/web/ace';
				ace.require("ace/config").set("workerPath", workerPath);
				var themePath = 'rwt-resources/src-js/razdslnvp1/web/ace';
				ace.require("ace/config").set("themePath", themePath);
				var modePath = 'rwt-resources/src-js/razdslnvp1/web/ace';
				...
				if (editor != null) {
					...
					ace.config.loadModule("ace/ext/language_tools", function (module) {
						...
						editor.setTheme("ace/theme/nvp1");
