 ...
 * @Generated
 */
define('ace/theme/nvp1', ['require', 'exports', 'module' , 'ace/lib/dom'], function(require, exports, module) {

exports.isDark = false;
exports.cssText = ".ace-nvp1 .ace_gutter {\
	background: #ebebeb;\
...
.ace-nvp1 .ace_storage,\
.ace-nvp1 .ace_keyword,\
.ace-nvp1 .ace_variable {\
	font-weight: bold;\
	color: rgb(120, 0, 45);\
}\
.ace-nvp1 .ace_constant.ace_buildin {\
	color: rgb(88, 72, 246);\
}\
.ace-nvp1 .ace_constant.ace_library {\
	color: rgb(6, 150, 14);\
}\
.ace-nvp1 .ace_function {\
	color: rgb(60, 76, 114);\
}\
.ace-nvp1 .ace_string {\
	color: rgb(42, 0, 255);\
}\
.ace-nvp1 .ace_comment {\
	color: rgb(113, 150, 130);\
}\
.ace-nvp1 .ace_comment.ace_doc {\
	color: rgb(63, 95, 191);\
}\
.ace-nvp1 .ace_comment.ace_doc.ace_tag {\
	color: rgb(127, 159, 191);\
}\
.ace-nvp1 .ace_constant.ace_numeric {\
	color: darkblue;\
}\
.ace-nvp1 .ace_tag {\
...
.ace-nvp1 .ace_marker-layer .ace_selection {\
	background: rgb(181, 213, 255);\
}\
.ace-nvp1 .ace_marker-layer .ace_bracket {\
	margin: -1px 0 0 -1px;\
	border: 1px solid rgb(192, 192, 192);\
}\
.ace-nvp1 .ace_meta.ace_tag {\
	color:rgb(25, 118, 116);\
}\
.ace-nvp1 .ace_invisible {\
	color: #ddd;\
}\
.ace-nvp1 .ace_entity.ace_other.ace_attribute-name {\
	color:rgb(127, 0, 127);\
}\
.ace-nvp1 .ace_marker-layer .ace_step {\
	background: rgb(255, 255, 0);\
}\
.ace-nvp1 .ace_marker-layer .ace_active-line {\
	background: rgb(232, 242, 254);\
}\
.ace-nvp1 .ace_marker-layer .ace_selected-word {\
	border: 1px solid rgb(181, 213, 255);\
}\
.ace-nvp1 .ace_indent-guide {\
